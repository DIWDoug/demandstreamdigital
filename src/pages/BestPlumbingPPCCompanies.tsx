              ...
              <section id="faq" className="mb-12">
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-13">
                    ...
                    <AccordionContent className="text-muted-foreground">
                      Demand Stream Digital was built specifically for plumbing and HVAC companies. We use transparent hourly billing ($100/hour) instead of percentage-of-spend pricing, so your costs don't increase as your ad budget grows. You get direct access to the person managing your campaigns, not a ticket queue. <IL to="/grow-qualifier">Start the conversation</IL> to see if we're the right fit.
                    </AccordionContent>
                  </AccordionItem>
