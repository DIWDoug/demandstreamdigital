...
import { googleAdsPlumbersConfig } from "@/data/listicles/google-ads-companies-for-plumbers";
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion";

const BestGoogleAdsCompaniesForPlumbers = () => {
  const config = googleAdsPlumbersConfig;
  const tocItems = [
        ...
        <div className="container mx-auto px-6 lg:px-8 py-12">
          <div className="grid lg:grid-cols-[280px_1fr] gap-8 xl:gap-12">
            <aside className="lg:sticky lg:top-24 lg:self-start hidden lg:block">
              ...
              <div className="mt-6">
                <ListicleCTA title="Need More Calls from Google Ads?" description="We run Google Ads and LSA campaigns built specifically for plumbing contractors. Every dollar tracked to booked jobs." />
              </div>
            </aside>
            <article className="max-w-none prose-headings:scroll-mt-24">
              ...
              <section id="agency-table" className="mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">Top Google Ads Companies for Plumbers in 2025</h2>
                <ListicleAgencyTable agencies={config.agencies} />
              </section>

              <section id="deep-dives" className="mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-8">Detailed Reviews: Best Google Ads Companies for Plumbers</h2>
...
export default BestGoogleAdsCompaniesForPlumbers;
