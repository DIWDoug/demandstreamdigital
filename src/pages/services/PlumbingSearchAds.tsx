...
const PlumbingSearchAds = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      { "@type": "Question", "name": "How do you handle peak season budget adjustments?", "acceptedAnswer": { "@type": "Answer", "text": "We build a seasonal bid calendar before campaigns launch. Budgets increase before and during peak demand windows. They hold back during shoulder season and shift emphasis toward maintenance and install promotions. You are not running the same budget in February as you are in July." } },
