...
const HVACWebsiteDesign = () => {
  ...
  return (
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      {/* WHY HVAC WEBSITES FAIL — Pattern B sticky-left */}
              ...
              <div className="lg:sticky lg:top-32">
                ...
                <div className="bg-gradient-to-r from-cta/5 to-transparent border-l-4 border-cta rounded-r-xl px-5 py-4 mb-8">
                  <p className="text-slate-700 text-sm leading-relaxed font-medium">
                    When a homeowner's AC goes out in July, they don't browse. They search and call whoever shows up first. An HVAC website built to generate calls needs separate pages for repair, install, and maintenance — not one page trying to do all three.
                  </p>
                </div>
