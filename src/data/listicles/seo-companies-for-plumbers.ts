...
export const plumbingSEOCompaniesConfig: ListicleConfig = {
  ...
  agencies: [
    ...
    // Rank 2 - The HOTH
    {
      ...
      deepDive: {
        tagline: "One of the largest SEO service providers with à la carte options and managed campaigns.",
        description: "Founded in 2010 in St. Petersburg, Florida, The HOTH (which stands for 'Hittem Over The Head') has become one of the most recognized names in outsourced SEO. They pioneered the à la carte model that lets businesses buy individual services like guest posts or press releases rather than committing to monthly packages. With over 200,000 customers and 287 Clutch reviews, they've built significant scale. However, this scale comes with tradeoffs: some clients report that quality varies depending on which team handles their account, and the volume-focused model can feel impersonal compared to boutique alternatives.",
        coreServices: [
          "HOTH X managed SEO campaigns with dedicated account management",
          "HOTH Guest Post for link building on real, vetted websites",
          ...
          "HOTH PPC for paid search management",
          "SEO reports and ranking tracking dashboards",
        ],
        whyTheyRank: [
          "Established track record with 15+ years in business and publicly verifiable client base",
          "Flexible à la carte purchasing lets you start small and scale gradually",
          "Extensive training resources and volume discounts for larger engagements",
          "Real-time order tracking and dashboard for monitoring campaign progress",
        ],
        clientTestimonials: [
          "We've used The HOTH for 5 years now. They're not the cheapest, but the consistency is worth it.",
    ...
    // Rank 3 - Boostability
    {
      ...
      deepDive: {
        tagline: "Enterprise-scale SEO built for high volumes of small business campaigns.",
        description: "Boostability has carved out a specific niche: they specialize in affordable SEO for small businesses. With over 450 employees in Lehi, Utah, they've built systems to handle thousands of concurrent SEO campaigns efficiently. Their technology stack focuses on automation and standardization, which keeps costs low but limits customization. If you need affordable, reliable SEO at scale, Boostability delivers. If you need a bespoke strategy tailored to your specific market, you'll likely find their approach too templated.",
        coreServices: [
          "Automated SEO campaigns with standardized optimization processes",
          "Client portal for campaign management and reporting",
        ...
        whyTheyRank: [
          ...
          "Strong infrastructure with dedicated support teams",
          "Competitive pricing enabled by their automation and scale",
          "Good entry point for businesses new to SEO",
        ],
        clientTestimonials: [
          "Perfect for franchise operations that need consistent SEO across dozens of locations.",
          "The automation keeps costs down, but don't expect customization beyond their standard packages.",
          "Solid for local businesses. Not the right fit for complex or competitive markets.",
        ],
      },
    },
    // Rank 4 - SEOReseller
    {
      ...
      deepDive: {
        tagline: "Full-service SEO platform with comprehensive tools and reporting since 2008.",
        description: "SEOReseller has been in the SEO services space since 2008, making them one of the longest-running providers around. Their differentiator is their complete infrastructure: dashboards, SEO tools, and reporting resources. The company operates out of the Philippines with US-facing sales and support, which helps keep their pricing competitive.",
        coreServices: [
          "Complete dashboard platform for campaign management",
          "SEO campaign management with tiered package options",
          "PPC and social media marketing services",
          "Web design and development services",
          "Reporting and analytics tools",
          "Training and certification programs",
        ],
        whyTheyRank: [
          "Comprehensive platform goes beyond SEO to support full digital marketing needs",
          "Strong infrastructure with client-facing tools included",
          "Long track record with transparent case studies and results",
          "Good value for businesses seeking a turnkey SEO solution",
        ],
        clientTestimonials: [
          "Their dashboard is a huge time saver for tracking campaign progress.",
          "Been with them for 6 years. Occasional content quality issues but support resolves quickly.",
          "The training resources helped us understand SEO better and ask the right questions.",
        ],
      },
    },
    // Rank 5 - DashClicks
    {
      ...
      deepDive: {
        tagline: "SaaS-first marketing platform with SEO fulfillment and 1,500+ verified reviews.",
        description: "DashClicks has grown rapidly by combining SEO fulfillment with a full marketing management SaaS platform. Their 4.9-star rating across 1,500+ reviews is impressive, though it's worth noting many reviews focus on their software rather than SEO results specifically. The platform includes CRM, project management, proposals, and marketing services all in one ecosystem.",
        coreServices: [
          "DashClicks platform with CRM, projects, and analytics",
          "SEO campaign management with monthly reporting",
          "PPC, social media, and web development services",
          "InstaReports for instant audit generation and sales tools",
          "Integrated invoicing and campaign management",
    ...
    // Rank 6 - WebFX
    {
      ...
      deepDive: {
        tagline: "Enterprise-grade SEO from a 500+ person company with proprietary MarketingCloudFX technology.",
        description: "WebFX is a full-service digital marketing company with enterprise-level capabilities. With 500+ employees and 30 years in business, they bring resources that smaller providers simply can't match. Their proprietary MarketingCloudFX platform provides AI-powered recommendations and attribution tracking.",
        coreServices: [
        ...
        whyTheyRank: [
          ...
          "Best choice for larger businesses with substantial budgets",
        ],
        clientTestimonials: [
          "The MarketingCloudFX data helped us prove ROI to a skeptical CFO. Worth the premium.",
          "Not cheap, but the execution is flawless. The strategy depth is unmatched.",
          "They found opportunities we'd overlooked for years.",
        ],
      },
    },
    // Rank 7 - Fat Joe
    {
      ...
      deepDive: {
        ...
        description: "Fat Joe started in Birmingham, UK and has grown into one of the largest à la carte content and link building providers in the industry. They process over 800 orders per day and serve 3,000+ businesses worldwide. Their model is straightforward: you order specific deliverables and receive them with quick turnaround.",
        coreServices: [
          ...
          "Reporting and order management portal",
        ],
        whyTheyRank: [
          ...
          "Per-piece pricing lets you match spend directly to your budget",
        ],
        clientTestimonials: [
          "Our go-to for blogger outreach. Quality has stayed consistent as they've scaled.",
          "Great for businesses that know exactly what they need. Not for beginners.",
    ...
    // Rank 8 - Loganix
    {
      ...
      deepDive: {
        ...
        description: "Loganix has built a strong reputation in the local SEO niche. Their citation building and cleanup services are particularly well-regarded, with detailed processes for NAP consistency across hundreds of directories. For local service businesses, they're a top choice.",
        coreServices: [
          ...
          "Local SEO reports with ranking maps",
        ],
        whyTheyRank: [
        ...
        clientTestimonials: [
          ...
          "Finally found a company that understands local SEO nuances. Great results for service businesses.",
    ...
    // Rank 9 - Victorious
    {
      ...
      monthlyVisits: "80K-100K",
      deepDive: {
        tagline: "Data-driven SEO company with transparent reporting and enterprise-level strategies.",
        description: "Victorious positions itself as a data-first SEO company, with heavy emphasis on analytics, attribution, and measurable ROI. They focus on high-end SEO for businesses that need sophisticated strategies and detailed performance tracking.",
        coreServices: [
        ...
        clientTestimonials: [
          "Their reporting makes it easy to see exactly what's working. Data speaks for itself.",
          "Finally an SEO company that speaks business language. ROI tracking is impeccable.",
          "Premium pricing but premium results. Worth the investment.",
        ],
      },
    },
    // Rank 10 - OuterBox
    {
      ...
      deepDive: {
        ...
        whyTheyRank: [
          "Deep e-commerce specialization rarely found in SEO companies",
    ...
    // Rank 11 - Sure Oak
    {
      ...
      deepDive: {
        tagline: "Growth-focused SEO company combining search optimization with conversion strategy.",
        ...
        clientTestimonials: [
          "They're the first SEO company that actually cared about our conversion rate, not just traffic.",
          "The combined SEO/CRO approach doubled our lead generation in 8 months.",
    ...
    // Rank 12 - Page One Power
    {
      ...
      deepDive: {
        ...
        whyTheyRank: [
          ...
          "Ideal for businesses in regulated or scrutinized industries",
        ],
        clientTestimonials: [
          "The link disclosure reports are thorough. Complete transparency on every placement.",
    ...
    // Rank 13 - Coalition Technologies
    {
      ...
      monthlyVisits: "60K-80K",
      deepDive: {
        tagline: "Design-forward LA company with proven ROI focus and strong e-commerce presence.",
        ...
        coreServices: [
          ...
          "Client-ready dashboards and reporting",
        ],
        whyTheyRank: [
        ...
        clientTestimonials: [
          "Their design team made our product pages actually sell, not just rank.",
          "Rare combination of creative and technical SEO expertise.",
          "Higher-touch experience than typical large SEO companies.",
        ],
      },
    },
    // Rank 14 - Straight North
    {
      ...
      deepDive: {
        ...
        clientTestimonials: [
          "The lead validation changed how we measure SEO success. Real opportunities, not vanity numbers.",
          "The focus on qualified leads over raw traffic makes a real difference.",
          "Their understanding of sales cycles helped us set realistic SEO timelines.",
        ],
      },
    },
    // Rank 15 - SEO.com
    {
      ...
      deepDive: {
        ...
        clientTestimonials: [
          "Strong brand recognition and the enterprise capabilities to back it up.",
          "Not for everyone, but for larger businesses, the premium is justified.",
    ...
    // Rank 16 - Thrive Internet Marketing Agency
    {
      ...
      deepDive: {
        tagline: "Texas-based full-service company with strong local SEO and reputation management.",
        description: "Thrive has grown from a Texas-based startup to a 250+ person company with clients across the United States. They offer full-service digital marketing but have particular strength in local SEO and reputation management.",
        coreServices: [
        ...
        whyTheyRank: [
          ...
          "Flexible service options from individual projects to full campaigns",
          "20 years of experience with stable processes",
        ],
        clientTestimonials: [
    ...
    // Rank 17 - Digital Current
    {
      ...
      monthlyVisits: "20K-30K",
      deepDive: {
        tagline: "Content-led SEO company with award-winning campaigns and creative approach.",
        ...
        coreServices: [
          ...
          "Creative campaigns and content assets",
        ],
        whyTheyRank: [
        ...
        clientTestimonials: [
          ...
          "Finally an SEO company that understands brand building, not just rankings.",
    ...
    // Rank 18 - Ignite Visibility
    {
      ...
      monthlyVisits: "60K-80K",
      deepDive: {
        tagline: "Inc. 5000 company with proprietary forecasting methodology and analytics focus.",
        ...
        coreServices: [
          ...
          "Reporting with forecast tracking",
        ],
        whyTheyRank: [
        ...
        clientTestimonials: [
          "The forecasting helped set realistic expectations. They hit their projections.",
          "Data-driven approach made it easy to understand what SEO could deliver.",
    ...
    // Rank 19 - Searchbloom
    {
      ...
      monthlyVisits: "25K-35K",
      deepDive: {
        tagline: "Utah-based company with proprietary ranking methodology and local market expertise.",
        ...
        whyTheyRank: [
          ...
          "Training programs help clients understand SEO better",
        ],
        clientTestimonials: [
          "Their methodology gave us a framework to understand exactly what they're doing and why.",
          "Consistent results across different client industries—the process works.",
          "The training helped us have more informed SEO conversations.",
        ],
      },
    },
    // Rank 20 - HigherVisibility
    {
      ...
      monthlyVisits: "40K-50K",
      deepDive: {
        tagline: "Memphis-based company named SEO Company of the Year by multiple industry publications.",
        ...
        whyTheyRank: [
          ...
          "Strong infrastructure with dedicated support",
        ],
        clientTestimonials: [
          "The awards aren't just marketing. Their work genuinely earns them.",
          "Great value compared to companies charging twice as much for similar work.",
          "Reliable and consistent. Never had to question their work quality.",
        ],
      },
    },
  ...
  faq: [
    ...
    {
      question: "How much does SEO cost for plumbing and HVAC companies?",
      answer: "SEO pricing varies widely. Basic local SEO packages typically run $500-$1,500/month. Mid-range campaigns covering multiple service areas cost $1,500-$3,500/month. Enterprise-level SEO for multi-location operations can exceed $5,000/month. Demand Stream Digital offers transparent hourly billing ($66/hour) so you only pay for the work that actually gets done.",
    },
    {
      question: "What should I look for in an SEO company?",
      answer: "Key factors include: proven track record with verifiable case studies, transparent reporting and communication, realistic expectations about timelines, quality content and link building practices (no black hat tactics), responsive support, and experience with plumbing or HVAC businesses. Also consider whether they use contracts and what their reporting looks like.",
    },
    {
      question: "How do I know if SEO is right for my business?",
