...
export const hubs: Hub[] = [
  {
    ...
    faqs: [
      { question: "How long does it take to see local SEO results?", answer: "Most campaigns show meaningful movement within 3-4 months, with substantial results by month 6. Competitive markets may take longer, while less competitive areas often see faster wins. We set realistic expectations during discovery." },
      { question: "Do you work with multi-location businesses?", answer: "Absolutely. We have specific processes for multi-location SEO including location page strategy, internal linking architecture, and scalable content frameworks. Many of our agency partners specialize in franchises and multi-location brands." },
      { question: "What's included in your local SEO service?", answer: "Our comprehensive service includes technical SEO audits, on-page optimization, content strategy and development, link building, citation management, and monthly reporting. We customize the scope based on market competition and client goals." },
      { question: "How do you handle client communication?", answer: "We operate 100% white-label. All communication flows through you. We provide you with reports, updates, and talking points—you maintain the client relationship and present the work as your own." }
    ],
    spokes: [
      {
