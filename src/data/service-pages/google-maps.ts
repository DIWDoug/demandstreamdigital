import { Map, MapPin, Zap, Users, Target, Star, MessageSquare, Globe, Layers, TrendingUp, Search, Sparkles, Mail, BarChart3, Share2 } from "lucide-react";
...
export const googleMapsConfig: ServicePageConfig = {
  ...
  roadmap: {
    ...
    phases: [
      ...
      },
      {
        phase: 2,
        name: "Velocity",
        title: "Review Generation & Active Management",
        description: "Systematic review acquisition and ongoing profile management that builds momentum and social proof.",
        activities: [
          ...
          "Industry-specific citation submissions",
      ...
      },
      {
        phase: 3,
        name: "Expansion",
        title: "Geographic Reach & Competitive Positioning",
        description: "Strategic efforts to expand visibility beyond immediate proximity and outposition competitors.",
        activities: [
      ...
      },
      {
        phase: 4,
        name: "Dominance",
        title: "Market Leadership & Sustained Visibility",
        description: "Maintaining top positions while defending against competitive threats and algorithm changes.",
        activities: [
  ...
  ecosystem: {
    ...
    services: [
      ...
      { icon: Globe, id: "authority", title: "Authority Building", description: "PR placements and backlinks that build trust.", href: "/white-label-inbound-marketing-services/authority" },
