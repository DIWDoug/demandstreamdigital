...
export const pageKeywords: Record<string, string> = {
  ...
  '/white-label-inbound-marketing-services/paid-media/google-ads': 'white label Google Ads, Google Ads management, search advertising, PPC campaign management',
  '/white-label-inbound-marketing-services/paid-media/meta-ads': 'white label Meta Ads, Facebook Ads management, Instagram advertising, social media ads',
  '/white-label-inbound-marketing-services/paid-media/local-service-ads': 'Local Service Ads management, LSA setup, Google Guaranteed, home service ads',
  '/white-label-inbound-marketing-services/paid-media/retargeting-campaigns': 'white label retargeting, display remarketing, audience retargeting, conversion optimization',
  '/white-label-inbound-marketing-services/paid-media/landing-page-design': 'PPC landing pages, conversion landing page design, campaign landing pages, high-converting pages',
  '/white-label-inbound-marketing-services/paid-media/conversion-tracking': 'conversion tracking setup, PPC analytics, Google Ads tracking, conversion attribution',
  
  // Email Marketing Hub + Spokes
  '/white-label-inbound-marketing-services/email-marketing': 'white label email marketing, email campaign management, newsletter services, email automation',
  '/white-label-inbound-marketing-services/email-marketing/campaign-strategy': 'email campaign strategy, email marketing planning, campaign calendar, email content strategy',
  '/white-label-inbound-marketing-services/email-marketing/list-management': 'email list management, list hygiene, subscriber management, email segmentation',
  '/white-label-inbound-marketing-services/email-marketing/automation-flows': 'email automation flows, drip campaigns, automated sequences, marketing automation',
  '/white-label-inbound-marketing-services/email-marketing/newsletter-design': 'newsletter design services, email template design, HTML email design, branded newsletters',
  ...
  '/white-label-inbound-marketing-services/local-authority-building/local-links': 'local link building, community backlinks, local news links, regional authority',
  '/white-label-inbound-marketing-services/local-authority-building/unstructured-citations': 'unstructured citations, press mentions, podcast features, media citations',
  '/white-label-inbound-marketing-services/local-authority-building/brand-mentions': 'brand mention building, online mentions, brand awareness, entity building',
  '/white-label-inbound-marketing-services/local-authority-building/anchor-text': 'anchor text optimization, link anchor strategy, branded anchors, natural anchor distribution',
  '/white-label-inbound-marketing-services/local-authority-building/sponsorships': 'local sponsorship links, community sponsorships, event sponsorship SEO, nonprofit links',
  '/white-label-inbound-marketing-services/local-authority-building/reputation-signals': 'reputation signals, trust signals, E-E-A-T building, authority signals',
  '/white-label-inbound-marketing-services/local-authority-building/guest-posts-niche-edits': 'guest posting services, niche edits, blogger outreach, editorial links',
  
  // Reporting Hub + Spokes
  '/white-label-inbound-marketing-services/reporting': 'white label reporting, agency dashboards, SEO reporting, marketing analytics',
  '/white-label-inbound-marketing-services/reporting/white-label-dashboards': 'white label dashboards, branded analytics, client dashboards, custom reporting',
  '/white-label-inbound-marketing-services/reporting/monthly-performance-reports': 'monthly SEO reports, performance reporting, client reports, marketing reports',
  '/white-label-inbound-marketing-services/reporting/rank-tracking-visibility': 'rank tracking services, keyword monitoring, SERP tracking, visibility reporting',
  '/white-label-inbound-marketing-services/reporting/call-tracking-lead-attribution': 'call tracking services, lead attribution, phone tracking, conversion attribution',
  '/white-label-inbound-marketing-services/reporting/roi-revenue-analysis': 'ROI analysis, revenue reporting, marketing ROI tracking, performance analytics',
  '/white-label-inbound-marketing-services/reporting/client-presentation-decks': 'client presentation decks, marketing presentations, QBR slides, client reporting decks',
};
