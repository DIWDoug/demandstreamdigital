...
export const caseStudyFullContent: Record<string, CaseStudyContent> = {
  ...
  "las-vegas-plumbing-seo": {
    ...
    results: "From -54% YoY decline in February 2025 to +3% YoY growth in December 2025 — a complete 57 percentage point swing reversing multi-year negative trends in just 10 months. 65 keywords now tracked, with #1 ranking for HVAC contractor Las Vegas, Top 5 for plumbing Las Vegas & plumber Las Vegas, and Top 3 Google Maps for plumber Las Vegas.",
    resultDetails: [
      ...
      "#1 for 'HVAC contractor Las Vegas'",
      ...
      "Top 3 Google Maps for 'plumber Las Vegas'",
      "Top 5 for 'plumbing Las Vegas' (4.4K search vol)",
      "Top 5 for 'plumber Las Vegas'",
