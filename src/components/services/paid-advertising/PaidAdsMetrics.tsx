...
const PaidAdsMetrics = () => {
  return (
    <section id="metrics" className="py-20 lg:py-28 bg-background scroll-mt-32">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-text-secondary mb-14 text-center max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-surface-elevated border-2 border-cta/30 rounded-xl p-8">
