...
const steps = [
  {
    ...
    content: "We start with a focused conversation to understand your dispatch capacity, service area, and growth targets. No one-size-fits-all approaches. Just clarity on what outcomes are realistic and what budget will support them."
  },
  {
    title: "Scope & Pricing",
  ...
  },
  {
    ...
    content: "Campaigns are structured by intent, geography, and service type. Ad copy is written to urgency and booking, not features. We launch when everything is verified."
  },
  {
    title: "Optimize & Report",
    content: "Weekly refinement cycles across search terms, bids, and audiences. Monthly reports focused on cost per booked call, booking rate, and dispatch load."
  },
  {
    title: "Scale & Retain",
    content: "As performance data accumulates, we expand into new keywords, geographies, and channels. Budget follows proven results. We grow with your capacity."
  }
];

const PaidAdsContactForm = forwardRef<HTMLElement>((_, ref) => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative z-20 bg-card border border-border rounded-2xl p-8 lg:p-12 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.08)] mb-[-5rem]">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div>
                  <TwoStepContactForm
                    formType="paid_ads_contact"
                    submitButtonText="Get a Paid Ads Performance Audit"
                    step1ButtonText="Get a Paid Ads Performance Audit"
                  />
...
PaidAdsContactForm.displayName = "PaidAdsContactForm";

export default PaidAdsContactForm;
