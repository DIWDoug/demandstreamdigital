      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-xs font-semibold tracking-widest uppercase text-cta mb-3">Built for Both</p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Paid Advertising Built for Plumbing. Built for HVAC.
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="bg-[#f9f9f9] border border-gray-200 rounded-2xl p-8">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-cta hover:text-cta/80 transition-colors group"
              >
                See what's included
