        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-sans font-semibold mb-4 animate-fade-in-up text-foreground" style={{ lineHeight: "1.1", animationDelay: "0.1s" }}>
              Plumbing Instagram Advertising That Builds Brand Authority and Drives Replacement Calls
            </h1>
            <p className="text-xl md:text-2xl font-sans font-semibold text-cta mb-6 animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
              Build Recognition Before They Call Your Competitor
            </p>
            <p className="text-base text-text-secondary max-w-xl mb-4 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.2s" }}>
              Homeowners don't always choose the first plumbing company they find. They choose the one they recognize. When a water heater starts failing or a homeowner gets their third slow drain in a year, the company they call is the one that has been showing up in their feed — with real job photos, credible work, and a clear sense of what they do.
            </p>
            <p className="text-base text-text-secondary max-w-xl mb-6 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.22s" }}>
              We use Instagram to build that recognition. Replacement services, financing campaigns, and brand reinforcement in your service area — before homeowners are in emergency mode and before competitors have the advantage of familiarity.
            </p>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.25s" }}>
            <div className="bg-surface-elevated/90 backdrop-blur-md border border-border rounded-2xl p-6 lg:p-8 shadow-xl">
              ...
              <TwoStepContactForm
                formType="plumbing_instagram_hero"
