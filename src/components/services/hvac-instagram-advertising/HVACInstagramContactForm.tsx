...
const HVACInstagramContactForm = forwardRef<HTMLElement>((_, ref) => {
  return (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">
              Ready to Build Brand Authority Before Peak Demand Hits?
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <p className="text-sm font-semibold text-accent-blue uppercase tracking-widest mb-4">One HVAC company per market. Your competitors don't get in.</p>
            ...
            <div className="bg-surface-elevated/90 backdrop-blur-md border border-border rounded-2xl p-6 lg:p-8 shadow-xl">
              <TwoStepContactForm
                formType="hvac_instagram_contact"
...
HVACInstagramContactForm.displayName = "HVACInstagramContactForm";

export default HVACInstagramContactForm;
