    ...
    <section className="py-16 lg:py-20 section-light relative">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="text-center mb-10">
          <span className="inline-block text-xs font-semibold uppercase tracking-[0.2em] text-accent-green mb-3">
            Explore More
          </span>
          ...
          {otherHubs.map((hub) => {
            ...
            return (
              <Link
                ...
                className="group p-6 rounded-xl bg-white border border-gray-200 hover:border-accent-green/30 hover:shadow-lg transition-all"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base font-semibold text-gray-900 group-hover:text-accent-green transition-colors mb-1 flex items-center gap-2">
                      {hub.title}
