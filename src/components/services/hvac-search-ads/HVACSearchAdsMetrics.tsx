        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-cta/5 border border-cta/20 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                {[
                  { label: "Cost Per Booked Call", desc: "acquisition cost tied directly to dispatched revenue" },
                  ...
                  { label: "Revenue Per Job", desc: "call mix quality by service type" },
                  { label: "Return on Ad Spend", desc: "budget producing more than it costs" },
                  { label: "Dispatch Load", desc: "capacity filled versus capacity available" },
                ].map((item, i) => (
...
export default HVACSearchAdsMetrics;
