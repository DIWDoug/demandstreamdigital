          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 lg:p-8 shadow-sm">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl lg:text-2xl font-semibold text-slate-900">Plumbing Local SEO</h3>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 lg:p-8 shadow-sm">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl lg:text-2xl font-semibold text-slate-900">HVAC Local SEO</h3>
              </div>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <Link 
                to="/plumbing-hvac-seo" 
                className="inline-flex items-center gap-2 text-amber-600 font-medium hover:text-amber-500 transition-colors text-sm"
              >
                HVAC SEO Details
                <ArrowRight className="w-4 h-4" />
              </Link>
