...
const PlumbingSearchAdsCredibility = () => {
  return (
          ...
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col items-center text-center">
              <div className="flex items-start" style={{ lineHeight: 1 }}>
                <span style={{ fontSize: "56px", fontWeight: 700, color: accentBlue, lineHeight: 1 }}>{stat.number}</span>
                {stat.unit && (
...
export default PlumbingSearchAdsCredibility;
