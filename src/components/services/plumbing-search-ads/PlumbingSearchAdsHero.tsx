        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-sans font-semibold mb-4 animate-fade-in-up text-foreground" style={{ lineHeight: "1.1", animationDelay: "0.1s" }}>
              Plumbing Search Ads That Drive
            </h1>
            <p className="text-xl md:text-2xl font-sans font-semibold text-cta mb-6 animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
              Booked Calls. Not Just Clicks.
            </p>
            <p className="text-base text-text-secondary max-w-xl mb-6 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.2s" }}>
              When someone searches 'emergency plumber near me' or 'drain cleaning today,' they are not browsing. They are calling whoever shows up first. Plumbing search advertising captures that intent before your competitors intercept the job.
            </p>
            ...
            <p className="text-sm text-text-secondary max-w-xl mb-2 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.28s" }}>
              We build campaigns around cost per booked call, service segmentation, and dispatch capacity. Not impressions. Not click-through rate. Plumbing companies only.
            </p>
          </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.25s" }}>
            <div className="bg-surface-elevated/90 backdrop-blur-md border border-border rounded-2xl p-6 lg:p-8 shadow-xl">
              ...
              <TwoStepContactForm
                formType="plumbing_search_ads_hero"
