...
const leftFAQs = [
  {
    q: "How much should I budget for plumbing search advertising?",
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-balance" style={{ color: "#0F172A" }}>
            Frequently Asked Questions About Plumbing Search Advertising
          </h2>
...
export default PlumbingSearchAdsFAQ;
