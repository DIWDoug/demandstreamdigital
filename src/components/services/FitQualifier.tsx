...
const FitQualifier = () => {
  ...
  const goodFit = [
    {
      point: "You run a plumbing, HVAC, or electrical company with annual revenue greater than $250,000",
    ...
    },
    {
      ...
      detail: "Most agencies treat you like every other client. We specialize in plumbing, HVAC, and electrical — we know your seasonality, your customers, and what actually drives calls."
    },
    {
    ...
    },
    {
      ...
      detail: "The best plumbing, HVAC, and electrical companies treat marketing like a new truck — it pays for itself many times over when done right."
    },
    {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              We work with established plumbing, HVAC, and electrical companies that want to dominate their local market — not just generate random traffic.
            </p>
          </div>
