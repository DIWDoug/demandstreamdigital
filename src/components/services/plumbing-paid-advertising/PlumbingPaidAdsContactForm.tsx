...
const PlumbingPaidAdsContactForm = forwardRef<HTMLElement>((_, ref) => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gray-900">
                Ready to Control Your Emergency Demand?
              </h2>
            ...
            <div className="relative z-20 bg-card border border-border rounded-2xl p-8 lg:p-12 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.08)] mb-[-5rem]">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div>
                  <TwoStepContactForm
                    formType="plumbing_paid_ads_contact"
...
PlumbingPaidAdsContactForm.displayName = "PlumbingPaidAdsContactForm";

export default PlumbingPaidAdsContactForm;
