...
const PlumbingPaidAdsBuiltForBoth = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            ...
            {/* Plumbing Card — active / current page */}
            <div className="bg-cta/5 border-2 border-cta/30 rounded-2xl p-8">
              <div className="w-12 h-12 rounded-xl bg-cta/10 flex items-center justify-center mb-6">
                <Wrench className="w-6 h-6 text-cta" strokeWidth={1.5} />
              </div>
            ...
            <div className="bg-[#f9f9f9] border border-gray-200 rounded-2xl p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Seasonal demand control for HVAC operators. Repair vs install segmentation, emergency surge defense, and shoulder season install pushes. Built around heating and cooling cycles.
              </p>
...
export default PlumbingPaidAdsBuiltForBoth;
