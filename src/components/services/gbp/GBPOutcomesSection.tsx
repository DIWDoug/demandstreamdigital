        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="text-center p-8 rounded-xl border bg-surface-elevated border-border/50">
            ...
            <p className="text-sm leading-relaxed text-text-secondary">
              ...
              <Link to="/plumbing-reporting" className="text-cta hover:underline">
          ...
          <div className="text-center p-8 rounded-xl border bg-surface-elevated border-border/50">
            ...
            <p className="text-sm leading-relaxed text-text-secondary">
              ...
              <Link to="/hvac-and-plumbing-seo" className="text-cta hover:underline">
                Local SEO
              </Link>
              ,{" "}
              <Link to="/hvac-and-plumbing-seo" className="text-cta hover:underline">
          ...
          <div className="text-center p-8 rounded-xl border bg-surface-elevated border-border/50">
            ...
            <p className="text-sm leading-relaxed text-text-secondary">
              <Link to="/plumbing-content-marketing" className="text-cta hover:underline">
                Service pages
              </Link>
              , FAQs, and{" "}
              <Link to="/hvac-and-plumbing-seo" className="text-cta hover:underline">
