...
const columns = [
  ...
  },
  {
    ...
    body: "We take one HVAC client per service area. When you work with DemandStream, your competitors don't. The strategy we build is designed to put you ahead, not split between you and the shop down the street.",
