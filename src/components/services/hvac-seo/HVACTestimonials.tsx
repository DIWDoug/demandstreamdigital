      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto text-slate-600">
            These are not agency reviews. They come from plumbing and HVAC companies that wanted more booked calls. And got them.
          </p>
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <span className="text-slate-600 text-sm font-medium">4.9 out of 5 · 22 Google Reviews for Demand Stream Digital</span>
          </div>
        </div>
