...
const placeholders = [
  {
    badge: "Add second HVAC operator review with revenue or booking metric badge",
  },
  {
    badge: "Add third HVAC operator review with revenue or booking metric badge",
  },
];
    ...
    <section className="py-24 lg:py-32 section-light relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className="text-center mb-16">
          <p className="text-sm text-accent-blue uppercase tracking-widest font-medium mb-4">What HVAC Operators Say</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {placeholders.map((p, i) => (
            <Card key={i} className="bg-white border-dashed border-slate-300">
              <CardContent className="p-6 flex flex-col items-center justify-center min-h-[200px] text-center">
                <p className="text-slate-400 text-sm italic">{p.badge}</p>
              </CardContent>
            </Card>
          ))}
        </div>
