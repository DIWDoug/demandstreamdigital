          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-6">
                HVAC is not a general home services business. It is a seasonal, emergency-driven trade where demand spikes in July and January — and misses the Map Pack during those windows mean real revenue walking out the door.
              </p>
              <div className="bg-gradient-to-r from-cta/5 to-transparent border-l-4 border-cta rounded-r-xl px-5 py-4 mb-8">
                <p className="text-slate-700 text-sm leading-relaxed font-medium">
                  When a homeowner's AC goes out on the hottest day of the year, they don't browse. They search and call whoever shows up first. HVAC SEO has to be built around that urgency, not applied from a template designed for every trade.
                </p>
              </div>
              <p className="text-slate-500 text-sm mb-8">
                Effective HVAC SEO requires scoping to the actual market. Not templated deliverables applied from a generic contractor package. That is why our HVAC SEO work performs consistently across different markets and service areas.
              </p>
