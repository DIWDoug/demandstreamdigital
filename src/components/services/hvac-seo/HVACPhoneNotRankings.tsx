...
const points = [
  {
    ...
    body: "Every HVAC SEO campaign we build includes call tracking. We track which searches and pages produce booked calls, not just call volume. Ranking data without call data is incomplete."
  },
  {
    icon: BarChart3,
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-surface-elevated border border-border/50 rounded-xl p-6 mb-10 text-center">
            <p className="text-text-secondary text-base leading-relaxed mb-3">
              An HVAC company with a <span className="text-foreground font-semibold">45% booking rate</span> produces different results than one running at <span className="text-foreground font-semibold">72%</span>.
            </p>
...
export default HVACPhoneNotRankings;
