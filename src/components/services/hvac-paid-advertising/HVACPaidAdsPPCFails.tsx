          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                HVAC advertising requires specialization. Seasonal volatility, emergency-first search behavior, repair vs install segmentation, and commercial growth opportunities all require structured campaign architecture.
              </p>
