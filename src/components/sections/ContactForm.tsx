...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="pt-24 lg:pt-32 pb-48 lg:pb-64 bg-surface-elevated relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Bleed-over Card */}
          <div className="relative z-10 bg-surface-dark border border-border rounded-2xl p-8 lg:p-12 shadow-2xl">
