...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="relative">
      ...
      <div className="absolute inset-0 bg-surface-elevated" style={{ bottom: '8rem' }} />
      ...
      <div className="relative pt-24 lg:pt-32 pb-8">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Bleed-over Card */}
            <div className="relative z-20 bg-surface-dark border border-border rounded-2xl p-8 lg:p-12 shadow-2xl mb-[-8rem]">
