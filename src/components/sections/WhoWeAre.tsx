          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-text-secondary leading-relaxed mb-6">
                We are a team of digital marketing specialists who work exclusively with plumbing and HVAC companies. We understand your service area, your seasonal call patterns, and the economics of a call-driven business.
              </p>
              <p className="text-text-secondary leading-relaxed mb-6">
                With 15+ years of hands-on execution across SMB and national campaigns, we built systems for businesses of every size and type. That experience taught us one thing clearly: specialization produces stronger results. We know how plumbing and HVAC companies generate revenue, how their customers search, and what it takes to move the needle on a dispatch board.
              </p>
              <p className="text-text-secondary leading-relaxed">
                That depth of experience is why DemandStream exists. Fifteen years of lessons, now applied with a clear focus on trade operators.
              </p>
            </div>
