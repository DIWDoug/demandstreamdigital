    ...
    <section
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-slate-700 text-base leading-relaxed">We do not treat digital marketing like a monthly experiment. We build it in phases. Every phase has a purpose. Every phase builds on the last.
